...
boolean lost = false;
	...
	public Board() {
		...
		setFocusable(true);
		ImageIcon i = new ImageIcon("D:\\koko's\\Jam3az\\Sem3\\OOP\\Challenge4\\Picture3.png");
		img = i.getImage();
		time = new Timer(5 ,this);
		time.start();
		en = new Enemy(700, 200, "D:\\koko's\\Jam3az\\Sem3\\OOP\\Challenge4\\Zombie.png");
		en2 = new Enemy(700, 200, "D:\\koko's\\Jam3az\\Sem3\\OOP\\Challenge4\\Zombie.png");
	}
...
public void checkCollisions()
{
 ...
 if (lost)
	...
	if (p.dy == 1 && done2 == false) {
		...
		g2d.drawString("Za5ira Left: " + p.za5ira, 500, 20);
		if (p.x > 400)
			if (en.Alive() == true)
